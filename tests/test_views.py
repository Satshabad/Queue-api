...
from api import app, models, init_db, views, feedback
User = models.User
...
class TestEnqueue(TestView):
    ...
    @patch('api.views.Linker.grooveshark')
    @patch('api.views.is_friends')
    @patch('api.views.Linker.spotify_artist')
    ...
    @patch('api.views.Linker.grooveshark')
    @patch('api.views.is_friends')
    @patch('api.views.Linker.spotify_song')
...
class TestListens(TestView):
    ...
    @patch('api.views.LastFMer')
    @patch('api.views.Twitterer')
